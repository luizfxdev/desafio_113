...
// Elementos do DOM
const inputNumbers = document.getElementById('input-numbers') as HTMLInputElement;
const calculateBtn = document.getElementById('calculate-btn') as HTMLButtonElement;
const resetBtn = document.getElementById('reset-btn') as HTMLButtonElement;
const resultContainer = document.getElementById('result-container') as HTMLDivElement;
const magicNumberElement = document.getElementById('magic-number') as HTMLDivElement;
const calculationElement = document.getElementById('calculation') as HTMLDivElement;
 ...
 */
function calculateMagicNumber(numbers: number[]): { result: number, steps: string } {
 ...
 */
function processInput(): number[] | null {
 ...
 */
function displayResult(result: number, steps: string): void {
